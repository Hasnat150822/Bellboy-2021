export const checkValues = [
    ...
    {id:'chk16', value:'User Management', viewValue:'User Management', selected:false},
    {id:'chk17', value:'Roles Management', viewValue:'Roles Management', selected:false},
    {id:'chk18', value:'Advertisement', viewValue:'Advertisement', selected:false},
    {id:'chk19', value:'Notification', viewValue:'Notification', selected:false},
    {id:'chk20', value:'Rider', viewValue:'Rider', selected:false},
    {id:'chk21', value:'Deliveries', viewValue:'Deliveries', selected:false},
    {id:'chk22', value:'Personal Assist', viewValue:'Personal Assist', selected:false},
    {id:'chk23', value:'B2B', viewValue:'B2B', selected:false},
    {id:'chk24', value:'Hiring Action Types', viewValue:'Action Types', selected:false},
    {id:'chk25', value:'Version Control', viewValue:'Version Control', selected:false}
  ] 